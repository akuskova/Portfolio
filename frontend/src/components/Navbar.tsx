...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 w-full flex items-center justify-between px-4 md:px-8 py-4 bg-midnight text-moonlight border-b-2 border-sunset z-50">
      <Link
        to="/"
        onClick={closeMenu}
      ...
      <div className="hidden md:flex gap-8">
        ...
        <div className="relative group">
          ...
          <div className="absolute left-0 pt-2 w-40 opacity-0 pointer-events-none group-hover:opacity-100 group-hover:pointer-events-auto transition-opacity duration-300">
            <div className="bg-evening border border-storm-light rounded-md shadow-xl">
      ...
      {/* Mobile menu */}
      {menuOpen && (
        <div className="md:hidden absolute top-full left-0 w-full bg-midnight border-b-2 border-sunset flex flex-col p-4 gap-3">
